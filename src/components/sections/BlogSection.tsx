      ...
      <div className="mx-auto max-w-3xl lg:max-w-5xl px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground mt-4 max-w-xl mx-auto">
            Artigos e guias sobre a intersecção entre tecnologia e crescimento.
          </p>
        </div>

        <div className="relative">
          <div className="relative z-10 grid grid-cols-6 gap-3">
            {/* Card 1 — Blog (col-span-2) */}
            <Card className="relative col-span-full flex overflow-hidden lg:col-span-2">
              <CardContent className="relative m-auto size-fit pt-6">
                <div className="relative flex h-24 w-56 items-center">
                  ...
                  <span className="mx-auto block w-fit text-5xl font-semibold text-primary">
                    Blog
                  </span>
                </div>
                ...
                <p className="text-muted-foreground text-sm text-center mt-2">
                  O risco invisível que trava o crescimento
                </p>
              </CardContent>
            </Card>

            {/* Card 2 — Guia (col-span-2) */}
            <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
              <CardContent className="pt-6">
                <div className="relative mx-auto flex aspect-square size-32 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
                  <BookOpen className="m-auto size-12 text-primary" strokeWidth={1} />
                </div>
                <div className="relative z-10 mt-6 space-y-2 text-center">
                  ...
                  <p className="text-muted-foreground text-sm">
                    Como implementar agentes de IA para qualificar leads e
            ...
            <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
              <CardContent className="pt-6">
                <div className="pt-6 lg:px-6">
                  ...
                  >
                    ...
                    <defs>
                      ...
                      >
                        <stop className="text-primary/25" stopColor="currentColor" />
                        <stop
                ...
                <div className="relative z-10 mt-14 space-y-2 text-center">
                  ...
                  <p className="text-muted-foreground text-sm">
                    Sistemas que &ldquo;funcionam&rdquo; podem estar drenando
                    recursos e impedindo a escalabilidade.
                  </p>
                </div>
              </CardContent>
            </Card>

            {/* Card 4 — ROI (col-span-3, com ícone + texto) */}
            <Card className="relative col-span-full overflow-hidden lg:col-span-3">
              <CardContent className="grid pt-6 sm:grid-cols-2">
                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                  <div className="relative flex aspect-square size-12 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
                    <FileText className="m-auto size-5 text-primary" strokeWidth={1} />
                  </div>
                  <div className="space-y-2">
                    <h2 className="text-lg font-medium text-white">
                      Modernização sem Pausa
                    </h2>
                    <p className="text-muted-foreground text-sm">
                      Migre sistemas legados para arquiteturas modernas
                      mantendo a operação 100% ativa.
                    </p>
                  </div>
                </div>
                ...
                <div className="relative z-10 mt-14 space-y-2 text-center">
                  ...
                  <p className="text-muted-foreground text-sm">
                    O custo invisível do sistema que &ldquo;funciona&rdquo; e
                    as estratégias para escalar de verdade.
                  </p>
                </div>
              </CardContent>
            </Card>

            {/* Card 5 — Prospecção IA (col-span-3, com visual timeline) */}
            <Card className="relative col-span-full overflow-hidden lg:col-span-3">
              <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground text-sm">
                      Quanto sua empresa pode economizar ao substituir
                      processos manuais por agentes de IA inteligentes.
                    </p>
                  </div>
                </div>
                <div className="before:bg-(--color-border) relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px sm:-my-6 sm:-mr-6">
                  <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                    <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                      <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm text-muted-foreground">
                        -70% tarefas manuais
                      </span>
                      <div className="ring-background flex size-7 items-center justify-center rounded-full bg-primary/20 ring-4">
                        <span className="text-[10px] text-primary font-bold">1</span>
                      </div>
                    </div>
                    <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
                      <div className="ring-background flex size-8 items-center justify-center rounded-full bg-primary/20 ring-4">
